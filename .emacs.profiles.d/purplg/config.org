...
(use-package telega
  ...
  (with-eval-after-load 'dashboard
    (require 'telega-dashboard "/home/purplg/.emacs.profiles.d/doom/.local/straight/repos/telega.el/contrib/telega-dashboard.el")
    (add-to-list 'dashboard-items '(telega-chats . 5) t)
    (add-hook 'telega-chat-update-hook 'dashboard-refresh-buffer-silent))
