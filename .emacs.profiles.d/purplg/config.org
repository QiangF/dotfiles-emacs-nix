...
#+BEGIN_SRC emacs-lisp :results none
(general-create-definer pg/leader-key
  :states '(normal visual)
  :prefix "SPC")

(general-create-definer pg/local-leader-key
  :states '(normal visual)
  :prefix "SPC m")
#+END_SRC
...
(use-package dashboard
  ...
  (pg/leader-key "o d" '(dashboard-switch :which-key "dashboard"))
