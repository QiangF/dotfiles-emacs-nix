...
Dunno why authentication fails when =:sasl_username= uses a similar as the =:sasl_secret= closure but for ~user~ instead. Whatever, the important part is the password
#+BEGIN_SRC emacs-lisp
(after! circe
